...
public class MediaViewerActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ImageButton) findViewById(R.id.btnEdit)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("item123",images.get(mViewPager.getCurrentItem()).getImageUrl());
                startActivityForResult(new Intent(MediaViewerActivity.this,PhotoEditorActivity.class).putExtra("type","url").putExtra("url", images.get(mViewPager.getCurrentItem()).getImageUrl()), 101);
            }
        });
