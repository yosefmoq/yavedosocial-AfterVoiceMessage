...
//    public static String regexPassword = "(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[\\d])(?=.*[~`!@#\\$%\\^&\\*\\(\\)\\-_\\+=\\{\\}\\[\\]\\|\\;:\"<>,./\\?]).{6,}";
    ...
    public void validateUserName(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexName, R.string.test);
    }
    ...
    public void validateEmail(int id) {
        mAwesomeValidation.addValidation(mContext, id, android.util.Patterns.EMAIL_ADDRESS,R.string.test);
    }

    public void validateOpationalEmail(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexOptionalEmailAddress, R.string.test);
    }

    public void validatePassword(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexPassword, R.string.test);
    }

    public void validateConfirmPassword(int idPassword, int idConfirm) {
        mAwesomeValidation.addValidation(mContext, idConfirm, idPassword, R.string.test);

    }

    public void validatePhone(int id) {
        mAwesomeValidation.addValidation(mContext, id, reqexPhone, R.string.test);

    }

    public void validateHeight(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexHeight, R.string.test);

    }

    public void validateWeight(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexWeight, R.string.test);

    }

    public void validateCode(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexCodeNumber, R.string.test);

    }

    public void validateTrackedNumber(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexCarSpeed, R.string.test);

    }


    public void validateDate(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexDate, R.string.test);

    }


    public void validateTextArea(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexTextArea, R.string.test);
    ...
    public void validatePrice(int id) {
        mAwesomeValidation.addValidation(mContext, id, regexPrice, R.string.test);
