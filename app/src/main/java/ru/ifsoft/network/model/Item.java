...
public class Item extends Application implements Constants, Parcelable {
    ...
    private int imagesCount = 0, feeling = 0, createAt, likesCount = 0, commentsCount, videoViewsCount, rePostsCount, allowComments, groupAllowComments, accessMode = 0, fromUserVerify = 0;
    ...
    private String reUrlPreviewTitle;
    private String reUrlPreviewImage;
    private String reUrlPreviewLink;
    private String reUrlPreviewDescription;
    ...
    public Item(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                this.setPostLang(jsonData.getString("postLang"));
                ...
                if(jsonData.has("VideoViewsCount")) {
                    this.setVideoViewsCount(jsonData.getInt("VideoViewsCount"));
                }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.postLang);
    }
