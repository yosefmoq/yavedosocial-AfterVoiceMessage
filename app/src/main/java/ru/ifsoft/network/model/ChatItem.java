...
public class ChatItem extends Application implements Constants, Parcelable {
    ...
    private String fromUserUsername, fromUserFullname, fromUserPhotoUrl, message, imgUrl,videoUrl , timeAgo, date, stickerImgUrl;
    ...
    public String toString() {
        return "ChatItem{" +
                ...
                ", stickerId=" + stickerId +
                ", id=" + id +
                ", fromUserState=" + fromUserState +
                ", fromUserVerify=" + fromUserVerify +
                ", createAt=" + createAt +
                ", seenAt=" + seenAt +
                ", listId=" + listId +
    ...
    public ChatItem(JSONObject jsonData) {
        ...
        try {
            ...
            this.setDuration(jsonData.getInt("duration"));
