...
public class DialogsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private InterstitialAd newInterstitialAd() {
        ...
        interstitialAd.setAdUnitId(getString(R.string.interstitialAd_ad_unit_id));
    ...
    private void loadInterstitial() {
        ...
        requestConfigurationBuilder
                //.setTestDeviceIds(Collections.singletonList("9464CD4E1BE3992346BB5C37655CA20B"))
                .build();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        initAdMobInt(); // ADMOB INIT

        Log.i("BRX", "DialogsFragment:");
