...
public interface Constants {
    ...
    // TODO: 08/12/2019 DEFUALT public static final int VIDEO_FILE_MAX_SIZE = 7340035; //Max size for video file in bytes | For example 7mb = 7*1024*1024
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyBghALmZwbHyfSyNVCYKDpYtId4Tjl-r4A";
    ...
    public static final String BILLING_KEY = "";

    public static final String WEB_SITE = "https://yavedo.com/";  //web site url address
    ...
    public static final String API_DOMAIN = "https://yavedo.com/";  // url address to which the application sends requests || 10.0.2.2
    ...
    public static final String METHOD_VIDEO_COUNT = API_DOMAIN + "api/" + API_VERSION + "/method/feeds.views" + API_FILE_EXTENSION;
    ...
    String METHOD_MSG_UPLOAD_VIDEO = API_DOMAIN + "api/" + API_VERSION + "/method/msg.uploadVideo" + API_FILE_EXTENSION;
    String METHOD_SHARE_LINK = API_DOMAIN + "api/" + API_VERSION + "/method/share.link" + API_FILE_EXTENSION;
    ...
    public static final int POST_CHARACTERS_LIMIT = 3000; // DEFAULT IS 1000
